...
namespace ChatServer
{
    ...
    {
        void FireRegister(string serverIp, string clientIp);
    ...
    public class ClientRegistryService : IClientRegistryService
    {
        ...
        public void FireRegister(string serverIp, string clientIp) => _db.StringSet(clientIp, serverIp, flags: CommandFlags.FireAndForget);
